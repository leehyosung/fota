...
function cleanServerProcess() {
    const processElement = document.getElementById('server_process_info');
    processElement.value = '';
}

function cleanDeviceProcess() {
    const processElement = document.getElementById('device_process_info');
    processElement.value = '';
}